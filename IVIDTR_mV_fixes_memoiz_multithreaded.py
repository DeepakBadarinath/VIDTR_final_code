        ...
        for t in np.arange(self.MDP.time_horizon-1, -1, -1):
            ...
            for l in range(self.max_lengths[t]-1):
                ...
                (optimal_cond_DBU, optimal_action, min_error, min_const_error,
                 min_complexity_error, optimal_bellman_error, error_df_t_l) = self.compute_errors_parallel(condition_DBUs, t, l, DBU, obs_states,
                                                                                                           integration_method, store_errors,
                                                                                                           conditions_string, max_workers=None)                      
                new_condition_DBUs = []                                         
                new_condition_dicts = {}                                       
                ...
                if store_errors:
                    ...
                    error_df = pd.concat([error_df, error_df_t_l], ignore_index=True)
                ...
                for a in self.MDP.action_spaces[t]:
                    ...
                    if store_errors:
                        ...
                        row = {
                                ...
                                'MaximBellmanError': maxim_bellman_error,
                                'FixedBellmanError' : fixed_bellman_error,
                                'Bellman_error': bellman_error,
                                'Action' : a,
                                'Constant_error': const_error,
